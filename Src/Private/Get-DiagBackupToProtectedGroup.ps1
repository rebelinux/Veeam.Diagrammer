                ...
                if ($ProtectedGroups) {
                    ...
                    if ($ADContainer) {
                        ...
                        if ($ADCNodes) {
                            ...
                            try {
                                $ADCNodesSubgraph = Get-DiaHTMLSubGraph -ImagesObj $Images -TableArray $ADCNodes -Align 'Center' -IconDebug $IconDebug -Label 'Active Directory Computers' -LabelPos "top" -fontColor $Fontcolor -TableStyle "dashed,rounded" -TableBorderColor $Edgecolor -TableBorder "1" -columnSize $ADCNodesColumnSize -IconType "VBR_AGENT_AD" -fontSize 18
                            } catch {
                    ...
                    if ($ManualContainer) {
                        ...
                        if ($MCNodes) {
                            ...
                            try {
                                $MCNodesSubgraph = Get-DiaHTMLSubGraph -ImagesObj $Images -TableArray $MCNodes -Align 'Center' -IconDebug $IconDebug -Label 'Manual Computers' -LabelPos "top" -fontColor $Fontcolor -TableStyle "dashed,rounded" -TableBorderColor $Edgecolor -TableBorder "1" -columnSize $MCNodesColumnSize -IconType "VBR_AGENT_MC" -fontSize 18
                            } catch {
                    ...
                    if ($IndividualContainer) {
                        ...
                        if ($ICCNodes) {
                            ...
                            try {
                                $ICCNodesSubgraph = Get-DiaHTMLSubGraph -ImagesObj $Images -TableArray $ICCNodes -Align 'Center' -IconDebug $IconDebug -Label 'Individual Computers' -LabelPos "top" -fontColor $Fontcolor -TableStyle "dashed,rounded" -TableBorderColor $Edgecolor -TableBorder "1" -columnSize $ICCNodesColumnSize -IconType "VBR_AGENT_IC" -fontSize 18
                            } catch {
                    ...
                    if ($CSVContainer) {
                        ...
                        if ($CSVCNodes) {
                            ...
                            try {
                                $CSVCNodesSubgraph = Get-DiaHTMLSubGraph -ImagesObj $Images -TableArray $CSVCNodes -Align 'Center' -IconDebug $IconDebug -Label 'CSV Computers' -LabelPos "top" -fontColor $Fontcolor -TableStyle "dashed,rounded" -TableBorderColor $Edgecolor -TableBorder "1" -columnSize $CSVCNodesColumnSize -IconType "VBR_AGENT_CSV_Logo" -fontSize 18
                            } catch {
